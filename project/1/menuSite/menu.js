...
xhr.open("GET", "http://127.0.0.1:8080/project/menuSite/menu.json");
xhr.send();
...
xhr.onreadystatechange = function () {
    if (xhr.readyState === XMLHttpRequest.DONE) {
        ...
        var $div = document.getElementsByClassName("drop-box")[0];
        $div.appendChild(dropFlex1.render());
        $div.appendChild(dropFlex2.render());
        $div.appendChild(dropFlex3.render());
